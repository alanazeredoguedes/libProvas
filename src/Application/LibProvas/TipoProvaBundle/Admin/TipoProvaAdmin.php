<?php
namespace App\Application\LibProvas\TipoProvaBundle\Admin;
...
class TipoProvaAdmin extends AbstractAdmin
{
    public function toString($object)
    {
        return $object instanceof TipoProva
            ? $object->getStringId()
